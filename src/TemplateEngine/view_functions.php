...
if (!function_exists('_array')) {
     ...
     *
     * @param mixed $array A value of any type
...
if (!function_exists('_default')) {
     ...
     * @param mixed $default The default value returned if the variable was not set
     * @param bool $return Return/Echo flag (default is to echo result)
     * @return mixed The result of the `_echo` function (string or bool)
     * @see _echo()
     */
...
if (!function_exists('_dump')) {
     ...
     * @param string $mask_item HTML mask used to build each item dump, parsed with `sprintf($mask, $index, $value)`
     * @param string $mask_global HTML mask used to build the full dump string, parsed with `sprintf($mask, $items_dump)`
     * @param string $no_index_mask_item HTML mask used to build each item dump without string index, parsed with `sprintf($mask, $value)`
     * @param bool $return Return/Echo flag (default is to echo result)
     * @return mixed The result of the `_echo` function (string or bool)
     * @see _echo()
     */
...
if (!function_exists('_eval')) {
     ...
     * Evaluation of code
     *
     * @param string $fct The string to evaluate
     * @param bool $return Return/Echo flag (default is to echo result)
     * @return mixed The result of the `_echo` function (string or bool)
     * @see _echo()
     */
